...
| クリップボード履歴 | 最近のテキスト・ファイル・画像を記録、ダブルクリックで貼り戻し；再起動をまたいで永続化；独立「クリップボード履歴」ウィンドウで検索・プレビュー・固定・削除・クリア・容量上限設定が可能 |
...
| メディア制御 | 「前へ」/「次へ」ボタンがシステムメディアキーを送信し、現在再生中のメディアセッションを制御します。トレイメニューの「メディア」サブメニューも同機能 |

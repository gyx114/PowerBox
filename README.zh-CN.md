...
| 剪贴板历史 | 记录最近文本/文件/图片，双击回写；跨程序重启持久化；"剪贴板历史"标签页显示全部条目（文本/文件/图片），双击回写；独立"剪贴板历史"窗口提供搜索、预览、置顶、删除、清空与体积上限设置，可由标签页顶部按钮或托盘菜单打开 |
...
| 媒体控制 | "上一首"/"下一首"按钮发送系统媒体键，控制当前播放的媒体会话；托盘菜单"媒体"子菜单提供相同功能 |
